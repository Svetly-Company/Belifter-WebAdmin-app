...
//import image
import Cliente from '@/app/assets/Cliente.jpg'
                ...
                <div className="flex flex-col">
                    <div className="flex justify-between">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <Link className="flex bg-primary-blue p-2 px-4 gap-1 rounded-xl" href="./CadastrarPerfilAluno"><GoPlus className="place-self-center text-2xl"/><p>Cadastrar aluno</p></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <Link href="/PerfilAluno" className="flex bg-[#3D383A] rounded-3xl items-center justify-between my-3 p-5  ">
